...
public class CityController {
    ...
    public String getCanBuild(String name) {
        StringBuilder str = new StringBuilder();
        City city = null;
        for (Civilization civilization : game.getCivilizations()) {
            for (City civilizationCity : civilization.getCities()) {
                if (civilizationCity.getName().equals(name)){
                    city = civilizationCity;
                    break;
                }
            }
        }
        for (Building building : city.getCanBuild()) {
            str.append(building.getName()).append("-");
        }
    ...
    public String building(String name) {
        StringBuilder str = new StringBuilder();
        for (BuildingsEnum building : Building.getAllBuildings()) {
            if (building.getName().equals(name)) {
                if (building.getNeededBuilding() == null)
                    str.append("nothing").append("-");
                else
                    str.append(building.getNeededBuilding().getName()).append("-");
                str.append(building.getCost()).append("-");
                str.append(building.getMaintenance()).append("-");
                break;
            }
        }
        return String.valueOf(str);
    ...
    public String createBuilding(String bu,String city1) {
        Building building = null;
        for (BuildingsEnum build : Building.getAllBuildings()) {
            if (building.getName().equals(bu)) {
        ...
        for (Civilization civilization : game.getCivilizations()) {
            for (City civilizationCity : civilization.getCities()) {
                if (civilizationCity.getName().equals(city1)){
                    city = civilizationCity;
                    break;
                }
            }
